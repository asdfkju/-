...
<br>
<label class="small" for="title">제목 :</label> <input type="text" name="title" id="title" />
...
<div class="spacer"></div>
        ...
        <input type="hidden" value="${bnum}" name="bnum" id="bnum">        
        </form>
                    <button onclick="sendForm()">전송</button> 
</div>
</body>
</html>